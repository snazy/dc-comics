...
public class ComicProcessor implements Processor {
    ...
    private Processor createDelegate() {
        ...
        final var loader = new InternalClassLoader(ComicProcessor.class.getClassLoader());
        try {
            currentThread.setContextClassLoader(loader);
            final var internalProcessor = loader.loadClass("com.dremio.cloud.comic.processor.internal.InternalComicProcessor");
            final var lookup = MethodHandles.privateLookupIn(ComicProcessor.class, MethodHandles.lookup());
    ...
    // X.class -> dc/comic/annotationprocessor/precompiled/X.classF
    private static class InternalClassLoader extends ClassLoader {
        ...
        protected Class<?> loadClass(final String name, final boolean resolve) throws ClassNotFoundException {
            synchronized (getClassLoadingLock(name)) {
                ...
                if (name.startsWith("com.dremio.cloud.comic.processor.internal.")) {
