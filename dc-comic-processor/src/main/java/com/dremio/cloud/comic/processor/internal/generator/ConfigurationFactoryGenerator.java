...
import com.dremio.cloud.comic.build.api.configuration.Property;
import com.dremio.cloud.comic.build.api.configuration.RootConfiguration;
import com.dremio.cloud.comic.processor.internal.Elements;
import com.dremio.cloud.comic.processor.internal.meta.Docs;
...
public class ConfigurationFactoryGenerator extends BaseGenerator implements Supplier<ConfigurationFactoryGenerator.Output> {
    ...
    static final String SUFFIX = "$ComicConfigurationFactory";
