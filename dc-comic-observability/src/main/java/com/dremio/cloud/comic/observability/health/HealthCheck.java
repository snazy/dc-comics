 ...
 * under the License.
 */
package com.dremio.cloud.comic.observability.health;
...
public interface HealthCheck {
    ...
    /**
     * IMPORTANT: ensure to implement some consistent timeouts and error handling if you deploy in kubernetes to avoid to hang any healthcheck or require comic to cancel them.
     *
