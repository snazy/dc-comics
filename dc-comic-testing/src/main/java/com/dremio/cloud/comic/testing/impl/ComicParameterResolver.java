...
public class ComicParameterResolver implements ParameterResolver, AfterEachCallback, TestInstancePostProcessor, AfterAllCallback {

    static final ExtensionContext.Namespace NAMESPACE = ExtensionContext.Namespace.create(ComicParameterResolver.class);

    @Override
    public boolean supportsParameter(final ParameterContext parameterContext, final ExtensionContext extensionContext) throws ParameterResolutionException {
        final var parameter = parameterContext.getParameter();
        return parameter.isAnnotationPresent(Comic.class) || parameter.getType() == RuntimeContainer.class;
    }
    ...
    private void doInject(final Object testInstance, final Class<?> aClass, final ExtensionContext context) {
        ...
        Stream.of(aClass.getDeclaredFields())
                .filter(it -> it.isAnnotationPresent(Comic.class))
