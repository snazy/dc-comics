 ...
 * under the License.
 */
package com.dremio.cloud.comic.httpclient.core.replay;

import com.dremio.cloud.comic.httpclient.core.DelegatingHttpClient;
import com.dremio.cloud.comic.httpclient.core.listener.impl.BaseHARDumperListener;
import com.dremio.cloud.comic.httpclient.core.listener.impl.har.HarJsonMapper;
...
public class NDJSONHttpClient extends DelegatingHttpClient.Synchronous implements AutoCloseable {
    ...
    private BaseHARDumperListener.Har.Entry readLine(final String line) {
        return mapper.fromString(BaseHARDumperListener.Har.Entry.class, line.strip());
    }
