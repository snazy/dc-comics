...
import com.dremio.cloud.comic.httpclient.core.response.StaticHttpResponse;
import com.dremio.cloud.comic.httpclient.core.response.StaticResponseInfo;
        ...
        return HttpHeaders.of(
                inMemory.response().headers() == null ?
                        ...
                        inMemory.response().headers().stream()
                                .collect(toMap(
                                        BaseHARDumperListener.Har.Header::name,
                                        h -> List.of(h.value()),
