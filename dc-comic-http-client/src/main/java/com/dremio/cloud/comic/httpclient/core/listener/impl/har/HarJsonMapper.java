...
public class HarJsonMapper extends JsonMapperImpl {
    ...
    public HarJsonMapper() {
        super(
                List.of(
                        new BaseHARDumperListener$Har$Cache$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Header$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$PostData$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$CacheRequest$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Identity$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Query$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Content$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Log$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Request$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Cookie$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Page$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Response$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Entry$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$PageTiming$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Timings$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$ComicJsonCodec(),
                        new BaseHARDumperListener$Har$Param$ComicJsonCodec()),
