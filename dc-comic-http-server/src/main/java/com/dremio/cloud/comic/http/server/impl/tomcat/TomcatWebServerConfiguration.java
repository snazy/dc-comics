...
public class TomcatWebServerConfiguration implements WebServer.Configuration {
    ...
    private String comicServletMapping = "/";
    ...
    public String getComicServletMapping() {
        return comicServletMapping;
    }

    public void setComicServletMapping(final String comicServletMapping) {
        this.comicServletMapping = comicServletMapping;
    }
    ...
    @Override
    public WebServer.Configuration comicServletMapping(final String comicServletMapping) {
        setComicServletMapping(comicServletMapping);
        return this;
    }
