...
public interface WebServer extends AutoCloseable, Unwrappable {
    ...
    interface Configuration extends Unwrappable {
        /**
         * @param mapping if comic servlet (custom endpoints) should be supported its mapping (servlet pattern), {@code -} to disable. Default to {@code /}.
         * @return this.
         */
        Configuration comicServletMapping(String mapping);
