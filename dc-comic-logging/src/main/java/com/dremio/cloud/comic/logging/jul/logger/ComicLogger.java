 ...
 * under the License.
 */
package com.dremio.cloud.comic.logging.jul.logger;

import com.dremio.cloud.comic.logging.jul.ComicLoggerFactory;
...
public class ComicLogger extends Logger {
    ...
    public ComicLogger(final String name, final String resourceBundleName, final ResourceBundle bundle) {
    ...
    private Logger getDelegate() {
        if (delegate == null) {
            synchronized (this) {
                if (delegate == null) {
                    if (GRAALVM) {
                        delegate = ComicLoggerFactory.get().getLogger(super.getName(), super.getResourceBundleName());
                    } else {
                        delegate = this;
                    }
                }
    ...
    public void log(final Level level, final String msg, final Throwable throwable) {
        ...
        delegate.log(level, msg, throwable);
    }
